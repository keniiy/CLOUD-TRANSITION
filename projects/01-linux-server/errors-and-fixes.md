...
## Issue: API not accessible from Mac

### Problem - API not accessible from Mac

After running the app with PM2, the API was not accessible from my Mac using the EC2 public IP.

### Cause - API not accessible from Mac
...
### Solution - API not accessible from Mac
...
1. Save the rules and test the API again using the public IP and port 3000.
